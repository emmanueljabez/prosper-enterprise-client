...
assert.match(pageSource, /Approval/)
...
assert.doesNotMatch(inviteDialogSource, /form\.firstName/)
assert.doesNotMatch(inviteDialogSource, /form\.lastName/)
assert.doesNotMatch(inviteDialogSource, /form\.title/)
assert.doesNotMatch(inviteDialogSource, /form\.department/)
assert.doesNotMatch(inviteDialogSource, /tagsText/)
assert.doesNotMatch(inviteDialogSource, /First name/)
assert.doesNotMatch(inviteDialogSource, /Last name/)
assert.doesNotMatch(inviteDialogSource, /Department/)
assert.doesNotMatch(inviteDialogSource, /Tags/)
