        ...
        <CardContent class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.allowNegativeStock" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.autoCreatePurchaseOrders" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.includeFreightInCost" />
            </div>
          </div>
        ...
        <CardContent class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableAutoReorder" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableLowStockAlerts" />
            </div>
          </div>
        ...
        <CardContent class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.autoGenerateBarcodes" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enforceLocationTracking" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.allowMultiLocationItems" />
            </div>
          </div>
        ...
        <CardContent class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.requireApprovalForAdjustments" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.requireApprovalForTransfers" />
            </div>
          </div>
        ...
        <CardContent class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableExpirationTracking" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableFefoAllocation" :disabled="!formData.enableExpirationTracking" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableCycleCounting" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableRealTimeReporting" />
            </div>
            ...
            <div class="flex items-center justify-between p-3 border rounded-lg">
              ...
              <Switch v-model:checked="formData.enableQuickbooksSync" />
            </div>
          </div>
